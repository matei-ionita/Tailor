...
components instead of one. We can use the method `customize_1D_mixtures()` to update a user-specified 
list of parameters. Compare the result to the previous 1-component model for CD127 above.
